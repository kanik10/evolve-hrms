...
import { type HolidayRecord } from "../data/holidays"
...
export function HolidayDeleteDialog({ holiday, open, onOpenChange, onConfirm }: HolidayDeleteDialogProps) {
  return (
      ...
      <AlertDialogContent className="max-w-md">
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            This will permanently remove the holiday from the calendar.
          </AlertDialogDescription>
        </AlertDialogHeader>
